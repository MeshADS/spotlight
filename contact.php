...
<html dir="ltr" lang="en-US">
  ...
  <body style="background-color: #000 !important;" class="contact">
    <div id="preloader">
      <div id="status">&nbsp;</div>
    </div>
    <!--Header Start-->
   <header>
      <div class="full-width">
        ...
        <nav id="menu" class="menu">
          <ul class="level-1">
           ...
           <!-- <li><a href="audphpition.php" class="hvr-overline-from-left"><i class="fa fa-pencil"></i> REGISTER</a></li>-->
            <li><a href="contact.php" class="hvr-overline-from-left active-menu"><i class="fa fa-phone"></i> CONTACT US</a></li>
    ...
    <section id="">
      ...
      <img style="width:100% !important;"  src="images/SPOTLIGHTArtboard1.png">
    </section>
    <!--Page Title Bar End-->
    <!--Mid Container Start-->
    <section class="parallax-container-2 contact-info">
      <!--<div class="container ">
        <div class="one-fourth2">
          <div class="icon-box">
            ...
            <div class="description">
              <h3>Location</h3>
              <p>Horlikins Event Centre. Plot 5,  Eastern Byepass,
                <br>Old GRA, Port Harcourt, Rivers State
              </p>
            </div>
          </div>
        </div>
      ...
      <div class='embed-container maps'>
        <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15903.348697896508!2d7.0123959!3d4.7979902!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x7c4144357bf2db04!2sHorlikins%20Event%20Centre!5e0!3m2!1sen!2sng!4v1576493118757!5m2!1sen!2sng" height="450" frameborder="0" style="border:0;" allowfullscreen=""></iframe>
        
      </div>
      <!--<div class="parallax-container-3">
        <div class="container">
          ...
          <div class="contact_form">
            <form id="contact-form" name="contact-form" action="sendEmail.php" method="post">
              <div id="main">
                <div id="contact_response" style="display: block;">
                  <div class="success"></div>
                </div>
                <div class="one-third">
                  <input type="text" placeholder="Name" size="23" id="name" name="name">
                </div>
                <div class="one-third">
                  <input type="text" size="23" id="email" placeholder="Email" name="email">
                </div>
                <div class="one-third-last">
                  <input type="text" size="23" id="subject" placeholder="Subject" name="subject">
                </div>
                <div class="fullwidth">
